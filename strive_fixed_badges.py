...
def get_pss10_questions():
    return [
        ...
        "Dalam sebulan terakhir, seberapa sering Anda marah karenahal-hal yang berada di luar kendali Anda?",
...
def show_landing_page():
    ...
    **STRIVE Pro** adalah platform assessment kesehatan mental yang komprehensif dan berbasis ilmiah, 
    ...
    # Features Overview dengan status yang sudah diperbaiki
    st.markdown("""
    ### 🚀 **Fitur Platform**
    """)
    ...
    with col1:
        st.markdown("""
        #### 📝 **Assessment Tools** <span style="background: linear-gradient(45deg, #2ecc71, #27ae60); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">✅ AVAILABLE</span>
        ...
        #### 🎨 **User Experience** <span style="background: linear-gradient(45deg, #2ecc71, #27ae60); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">✅ AVAILABLE</span>
    ...
    with col2:
        st.markdown("""
        #### 📊 **Basic Analytics** <span style="background: linear-gradient(45deg, #2ecc71, #27ae60); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">✅ AVAILABLE</span>
        ...
        #### 🔐 **Privacy & Security** <span style="background: linear-gradient(45deg, #2ecc71, #27ae60); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">✅ AVAILABLE</span>
    ...
    # Coming Soon Features dengan badge yang diperbaiki
    st.markdown("""
    ...
    with tab1:
        st.markdown("""
        **🤖 AI-Powered Analysis** <span style="background: linear-gradient(45deg, #ff6b6b, #feca57); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">🚀 COMING SOON</span>
        ...
        **🧠 Machine Learning** <span style="background: linear-gradient(45deg, #ff6b6b, #feca57); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">🚀 COMING SOON</span>
    ...
    with tab2:
        st.markdown("""
        **📊 Enterprise Analytics** <span style="background: linear-gradient(45deg, #ff6b6b, #feca57); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">🚀 COMING SOON</span>
        ...
        **🏢 Organization Management** <span style="background: linear-gradient(45deg, #ff6b6b, #feca57); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">🚀 COMING SOON</span>
    ...
    with tab3:
        st.markdown("""
        **📄 Professional Reporting** <span style="background: linear-gradient(45deg, #ff6b6b, #feca57); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">🚀 COMING SOON</span>
        ...
        **📧 Communication Suite** <span style="background: linear-gradient(45deg, #ff6b6b, #feca57); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">🚀 COMING SOON</span>
    ...
    with tab4:
        st.markdown("""
        **👥 Multi-User Ecosystem** <span style="background: linear-gradient(45deg, #ff6b6b, #feca57); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">🚀 COMING SOON</span>
        ...
        **🔐 Advanced Security** <span style="background: linear-gradient(45deg, #ff6b6b, #feca57); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">🚀 COMING SOON</span>
    ...
    # Current Available Sectors dengan badge yang diperbaiki
    st.markdown("""
    ...
    with tab1:
        st.markdown("""
        **Healthcare Organizations** <span style="background: linear-gradient(45deg, #2ecc71, #27ae60); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">✅ AVAILABLE</span>
        - ✅ Patient mental health screening
        - ✅ Basic progress monitoring
        - ✅ Risk assessment dengan validated tools
        - <span style="background: linear-gradient(45deg, #ff6b6b, #feca57); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">🚀 COMING SOON</span> Advanced clinical workflows
        - <span style="background: linear-gradient(45deg, #ff6b6b, #feca57); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">🚀 COMING SOON</span> EHR integration
        """, unsafe_allow_html=True)
    
    with tab2:
        st.markdown("""
        **Corporate Wellbeing** <span style="background: linear-gradient(45deg, #2ecc71, #27ae60); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">✅ AVAILABLE</span>
        - ✅ Employee mental health screening
        - ✅ Individual stress management
        - ✅ Burnout assessment tools
        - <span style="background: linear-gradient(45deg, #ff6b6b, #feca57); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">🚀 COMING SOON</span> HR system integration
        - <span style="background: linear-gradient(45deg, #ff6b6b, #feca57); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">🚀 COMING SOON</span> Workforce analytics dashboard
        """, unsafe_allow_html=True)
    
    with tab3:
        st.markdown("""
        **Educational Institutions** <span style="background: linear-gradient(45deg, #2ecc71, #27ae60); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">✅ AVAILABLE</span>
        - ✅ Student individual assessment
        - ✅ Staff wellbeing evaluation
        - ✅ Basic counseling support tools
        - <span style="background: linear-gradient(45deg, #ff6b6b, #feca57); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">🚀 COMING SOON</span> Student information system integration
        - <span style="background: linear-gradient(45deg, #ff6b6b, #feca57); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">🚀 COMING SOON</span> Campus-wide mental health analytics
        """, unsafe_allow_html=True)
    
    with tab4:
        st.markdown("""
        **Research Applications** <span style="background: linear-gradient(45deg, #2ecc71, #27ae60); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">✅ AVAILABLE</span>
        - ✅ Individual data collection
        - ✅ Basic research-grade assessments
        - ✅ Downloadable results for analysis
        - <span style="background: linear-gradient(45deg, #ff6b6b, #feca57); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">🚀 COMING SOON</span> Advanced data export formats
        - <span style="background: linear-gradient(45deg, #ff6b6b, #feca57); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">🚀 COMING SOON</span> Research dashboard & analytics
        """, unsafe_allow_html=True)
...
def show_assessment_selection():
    ...
    # Feature Status Info yang diperbaiki
    st.markdown("""
    <div style="background: #f8f9fa; padding: 1rem; border-radius: 8px; margin-bottom: 2rem; border-left: 4px solid #28a745;">
    <strong>ℹ️ Status Fitur:</strong> Assessment tools di bawah ini <span style="background: linear-gradient(45deg, #2ecc71, #27ae60); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">✅ AVAILABLE</span> dan siap digunakan. 
    Fitur advanced seperti AI analysis, enterprise dashboard, dan professional PDF reports <span style="background: linear-gradient(45deg, #ff6b6b, #feca57); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">🚀 COMING SOON</span>.
    </div>
    """, unsafe_allow_html=True)
    ...
    for key, assessment in assessments.items():
        status_badge = "✅ AVAILABLE" if assessment['status'] == 'available' else "🚀 COMING SOON"
        badge_color = "#2ecc71" if assessment['status'] == 'available' else "#ff6b6b"
...
def show_footer():
    ...
    # Version & Stats Info dengan Coming Soon indicators yang diperbaiki
    ...
    with col1:
        ...
        **📱 App Info**
        ...
        - Build: Production
        - Status: <span style="background: linear-gradient(45deg, #2ecc71, #27ae60); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">✅ AVAILABLE</span>
        """, unsafe_allow_html=True)
    ...
    with col2:
        ...
        **📊 Current Stats**
        ...
        - Multi-language: <span style="background: linear-gradient(45deg, #ff6b6b, #feca57); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">🚀 COMING SOON</span>
        """, unsafe_allow_html=True)
    
    with col3:
        st.markdown(f"""
        **🔒 Security & Privacy**
        - Data: Local Processing <span style="background: linear-gradient(45deg, #2ecc71, #27ae60); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">✅ AVAILABLE</span>
        - Storage: Session-based <span style="background: linear-gradient(45deg, #2ecc71, #27ae60); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">✅ AVAILABLE</span>
        - Enterprise Auth: <span style="background: linear-gradient(45deg, #ff6b6b, #feca57); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">🚀 COMING SOON</span>
        - GDPR Compliance: <span style="background: linear-gradient(45deg, #2ecc71, #27ae60); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">✅ AVAILABLE</span>
        """, unsafe_allow_html=True)
...
def show_assessment():
    ...
    # Header dengan status yang diperbaiki
    st.markdown(f"""
    # 📋 {title} <span style="background: linear-gradient(45deg, #2ecc71, #27ae60); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">✅ AVAILABLE</span>
    """, unsafe_allow_html=True)
...
def show_results():
    ...
    # Coming Soon Features Info yang diperbaiki
    st.markdown("""
    <div style="background: #fff3cd; border: 1px solid #ffeaa7; border-radius: 8px; padding: 1rem; margin: 2rem 0;">
        ...
        <ul style="margin: 0.5rem 0;">
            <li>🤖 AI-powered risk prediction & personalized interventions <span style="background: linear-gradient(45deg, #ff6b6b, #feca57); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">🚀 COMING SOON</span></li>
            <li>📊 Advanced analytics dengan trend analysis <span style="background: linear-gradient(45deg, #ff6b6b, #feca57); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">🚀 COMING SOON</span></li>
            <li>📄 Professional PDF reports dengan clinical formatting <span style="background: linear-gradient(45deg, #ff6b6b, #feca57); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">🚀 COMING SOON</span></li>
            <li>📧 Automated email delivery & follow-up scheduling <span style="background: linear-gradient(45deg, #ff6b6b, #feca57); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">🚀 COMING SOON</span></li>
        </ul>
    </div>
    """, unsafe_allow_html=True)
...
"""
        ...
        st.caption("""📄 Professional PDF Reports <span style="background: linear-gradient(45deg, #ff6b6b, #feca57); color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8em; font-weight: bold; margin-left: 8px;">🚀 COMING SOON</span>""", unsafe_allow_html=True)
